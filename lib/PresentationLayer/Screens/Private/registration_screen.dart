                    ...
                    InkWell(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              registrationStudentController.gradeText ?? 'اختر الصف',
                          ...
                          itemBuilder: (context, i) {
                            return InkWell(
                              onTap: (){
                                ...
                                registrationStudentController.setGradId(gradesController.grades[i].id,gradesController.grades[i].name
                               +  "--"+gradesController.grades[i].fee.toString());
                                Get.back();
                              },
                              child: GradesItem(
